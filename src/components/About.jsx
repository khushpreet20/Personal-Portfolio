    ...
    <div className='border-b border-neutral-900 pb-4'>
        ...
        <div className='flex flex-wrap'>
          ...
          whileInView="visible"
           className='w-full lg:w-1/2 lg:p-8'>
            <div className='flex items-center justify-center'>
                <img className = "w-3/5 rounded-2xl" src={profilePic} alt="about" />
            </div>
          </motion.div>
          <motion.div 
          ...
          className='w-full lg:w-1/2'>
              ...
              <a href = 'https://drive.google.com/file/d/1xAaOUUHXBMoBlbvCEMGbTE0aQgKSXScZ/view?usp=sharing' className='px-2 py-1 rounded font-semibold cursor-pointer bg-slate-900 text-neutral-300 dark:bg-neutral-300 dark:text-neutral-900 '>Resume</a>
          </motion.div>
        </div>
    </div>
  )
